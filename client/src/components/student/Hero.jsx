...
const Hero = () => {
    return (
        <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cycn-100/70'>
            ...
            <h1 className='md:text-home-heading-large text-home-heading-small font-bold text-gray-800 max-w-3xl mx-auto'>
                Empower your future with the courses designed to fit
                <span className="relative inline-block text-blue-600 ml-2">
                    your choice.
                    <img
                        src={assets.sketch}
                        alt="sketch"
                        className="md:block hidden absolute -bottom-7 left-12 "
                    />
                </span>
            </h1>
